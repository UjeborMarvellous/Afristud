...
function Navbar() {
    ...
    return (
        <div>
            <nav className={color ? "transition-opacity z-50 delay-150 ease-linear duration-300 bg-black fixed -top-1 w-full py-6 translate-y scroll-smooth px-[6%]" : "z-50 absolute w-full lg:py-10 md:py-5 sm:py-5 px-[6%]"}>
                <div className={color ? " navLinks  flex justify-between" : "navLinks  justify-between flex"}>
                    ...
                    <div className="Open absolute right-6 top-7 lg:hidden md:hidden scale-150">
                        <FiMenu
